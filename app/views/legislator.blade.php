...
<h1>&nbsp;{{$leg->first_name." ".$leg->last_name}}</h1><p>&nbsp;&nbsp;&nbsp;<a href="/legadd/{{$leg->id}}/" class="btn btn-default btn-small" role="button"><span class="glyphicon glyphicon-pencil"></span> Add to Favorites</a></p>
